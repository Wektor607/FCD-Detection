    ...
    def __init__(
        ...
        with open(csv_path, "r") as f:
            self.data = pd.read_csv(
                f, sep=",", engine="python", quoting=csv.QUOTE_NONE, escapechar="\\"
            )
        ...
        params = next(iter(self.config.losses)) if isinstance(self.config.losses, list) else self.config.losses
