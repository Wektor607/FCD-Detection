...
\begin{figure}[h]
    ...
    \caption{Typical features of focal cortical dysplasias (FCDs) visible in \ac{mri}~\cite{walger2023ai_fcd}}
    \label{unseen_fcds}
\end{figure}
...
In the context of epileptogenic lesion detection, such textual information can reflect prior clinical knowledge derived from examinations other than \ac{mri}, such as EEG findings or seizure semiology.  
