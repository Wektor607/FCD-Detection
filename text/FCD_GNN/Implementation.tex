...
The main page presents a brief overview of the project and includes navigation controls that let users explore the documentation or move on to the prediction page for processing a specific patient (see Fig.~\ref{fig:web_main_page}).
...
The 2D output is not interactive, and slice selection or navigation is not supported in the current prototype.
