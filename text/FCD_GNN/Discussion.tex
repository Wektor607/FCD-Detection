...
\begin{enumerate}
  ...
  Such cues can narrow the search space and reduce the need to attend over the entire cortex.
  ...
  This acts as mild regularization: predictions become more conservative, reducing false positives, which can improve precision (e.g., PPV), while sensitivity and Dice often remain stable.
\end{enumerate}
