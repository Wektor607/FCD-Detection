...
\begin{itemize}
    ...
    \begin{table}[t]
    \centering
    \caption{Text conditioning variants used in \texttt{Vision+LM}.}
    ...
    \item \textbf{Vision+LM\_mixed (GuideDecoder + Text).} 
...
Across all \textit{Vision+LM models}, specificity was $\sim$36--42 percentage points higher than that of MELD. 
...
Across all \textit{Vision+LM models}, specificity was higher than that of MELD by approximately 36--42 percentage points.
This indicates that the text--conditioned models distinguish healthy from non--healthy cases substantially better.
...
Each figure shows (from left to right) the ground-truth lesion mask, the prediction of the baseline MELD model, and the prediction of the proposed \texttt{Vision+LM} model with PubMedBERT using the \texttt{hemi+lobe} prompt.
...
\hline
Vision--only: 1 layer   & \makecell{\colorbox{orange!15}{0.235} \\ (0.096--0.313)} & \makecell{\colorbox{green!15}{0.235} \\ (0.148--0.362)} & \colorbox{green!15}{0.603} & \makecell{\colorbox{orange!15}{0.133} \\ (0.051--0.186)} & \makecell{67.2 (n=174) \\ (61.4--73.0)} \\
\hline
Vision--only: 2 layers  & \makecell{0.234 \\ (0.126--0.334)} & \makecell{\colorbox{orange!15}{0.219} \\ (0.136--0.371)} & \colorbox{cyan!15}{0.573} & \makecell{0.132 \\ (0.067--0.200)} & \makecell{68.3 (n=177) \\ (62.5--74.1)} \\
\hline
Vision--only: 3 layers  & \makecell{\colorbox{green!15}{0.249} \\ (0.114--0.332)} & \makecell{\colorbox{cyan!15}{0.224} \\ (0.142--0.341)} & 0.479 & \makecell{\colorbox{green!15}{0.142} \\ (0.060--0.199)} & \makecell{\colorbox{cyan!15}{69.9 (n=181)} \\ (64.1--75.3)} \\
\hline
Vision--only: 4 layers  & \makecell{0.231 \\ (0.097--0.304)} & \makecell{0.180 \\ (0.128--0.283)} & \colorbox{orange!15}{0.540} & \makecell{0.130 \\ (0.051--0.179)} & \makecell{68.3 (n=177) \\ (62.5--74.1)} \\
\hline
Vision--only: 5 layers  & \makecell{0.223 \\ (0.081--0.312)} & \makecell{0.172 \\ (0.090--0.261)} & 0.533 & \makecell{0.125 \\ (0.042--0.185)} & \makecell{66.0 (n=171) \\ (60.2--71.8)} \\
\hline
Vision--only: 6 layers  & \makecell{0.208 \\ (0.121--0.312)} & \makecell{\colorbox{orange!15}{0.219} \\ (0.147--0.336)} & 0.539 & \makecell{0.116 \\ (0.065--0.185)} & \makecell{69.1 (n=179) \\ (63.3--74.9)} \\
\hline
Vision--only: 7 layers  & \makecell{0.206 \\ (0.119--0.293)} & \makecell{\colorbox{orange!15}{0.219} \\ (0.135--0.341)} & 0.436 & \makecell{0.115 \\ (0.063--0.172)} & \makecell{\colorbox{green!15}{72.6 (n=188)} \\ (67.2--78.0)} \\
\hline
\end{tabular}
\end{table}
...
\item for each GNN depth, we initialize the model from the corresponding best--performing \texttt{Vision--only}+GNN checkpoint and employ a 5-epoch decoder warm--up, after which the full decoder is unfrozen.
\end{enumerate}
