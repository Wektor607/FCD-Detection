...
Along similar lines, House et al.~\cite{house2021automated_fcd} introduced a clinically integrated 3D convolutional neural network for the automated detection and segmentation of \ac{fcd} lesions from routine T1--weighted and FLAIR MRI sequences.
...
Nevertheless, the model exhibits substantially lower detection performance for subtle or non--sclerotic \ac{fcd} subtypes compared to more pronounced Taylor-type \ac{fcd}, suggesting a bias toward more conspicuous lesion patterns and limited generalization across the full pathological spectrum.
